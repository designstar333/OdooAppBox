...
export class HomePage implements AfterViewInit{
  ...
  <div>
    ...
    <div class="content" style="padding:0 1.5rem;">
      ...
      <p>OdooAppBox Community is open source edition, compatible with Odoo8~Odoo12. OdooAppBox Community git repository is https://github.com/designstar333/OdooAppBox/.</p>
      ...
      <h1>Contact us</h1>
      <p>Email: designstar333@gmail.com</p>
      <p>QQ: 1294739135</p>
  ...
  <div>
    ...
    <div class="content" style="padding:0 1.5rem;">
      ...
      <h1>社区版</h1>
      <p>OdooAppBox社区版为开源版本，支持Odoo8~Odoo12社区版和企业版。源码托管地址https://github.com/designstar333/OdooAppBox/</p>
      <h1>企业版</h1>
      <p>OdooAppBox企业版是社区版的增强版本，支持Odoo8~Odoo12，额外提供扫码出入库、扫码报工等功能以及更少的限制</p>
      <h1>版本定制</h1>
      <p>如您有UI修改、功能定制等需求，可联系作者定制</p>
      <h1>联系我们</h1>
      <p>作者邮箱：designstar333@gmail.com</p>
      <p>作者QQ：1294739135</p>
      <div style="display: flex; justify-content: center;">
        <img src="assets/imgs/logo.png" width='128' height='128' style="background-color: #c392b6;"/>
      </div>
